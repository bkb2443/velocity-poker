...
var file_proto_cards_proto_rawDesc = []byte{
	0x0a, 0x11, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x61, 0x72, 0x64, 0x73, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x63, 0x61, 0x72, 0x64, 0x73, 0x22, 0x1b, 0x0a, 0x07, 0x4d, 0x65,
	...
	,
}

var (
	file_proto_cards_proto_rawDescOnce sync.Once
	file_proto_cards_proto_rawDescData = file_proto_cards_proto_rawDesc
)

func file_proto_cards_proto_rawDescGZIP() []byte {
	file_proto_cards_proto_rawDescOnce.Do(func() {
		file_proto_cards_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_cards_proto_rawDescData)
	})
	return file_proto_cards_proto_rawDescData
}

var file_proto_cards_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_cards_proto_goTypes = []interface{}{
	(*Message)(nil),           // 0: cards.Message
	(*Request)(nil),           // 1: cards.Request
	(*Response)(nil),          // 2: cards.Response
	(*StreamingRequest)(nil),  // 3: cards.StreamingRequest
	(*StreamingResponse)(nil), // 4: cards.StreamingResponse
	(*Ping)(nil),              // 5: cards.Ping
	(*Pong)(nil),              // 6: cards.Pong
}
var file_proto_cards_proto_depIdxs = []int32{
	1, // 0: cards.Cards.Call:input_type -> cards.Request
	3, // 1: cards.Cards.Stream:input_type -> cards.StreamingRequest
	5, // 2: cards.Cards.PingPong:input_type -> cards.Ping
	2, // 3: cards.Cards.Call:output_type -> cards.Response
	4, // 4: cards.Cards.Stream:output_type -> cards.StreamingResponse
	6, // 5: cards.Cards.PingPong:output_type -> cards.Pong
...
func file_proto_cards_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_cards_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_cards_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_cards_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_cards_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_cards_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_cards_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Ping); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_cards_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_cards_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_proto_cards_proto_rawDesc = nil
